...
//===================================  uninitialized_copy  ===================================//
/*
	  功能：将内存中first到last之间的数据copy到以result为起始位置的内存中。
	  参数说明：
...
/*
	功能：作用于未初始化的内存（ first ~ last ）进行赋值X。
	参数：1、迭代器first指向输出端(欲初始化空间)的起始处。
...
/*
	  功能：作用于未初始化的内存（ first ~ frist + n ）进行赋值X。
	  参数：1、迭代器 first 指向欲初始化空间的起始处。
			2、n 是欲初始化空间的大小。
			3、x 表示初值
*/
